...
bool AccelStepper::runSpeed() {
  ...
  unsigned long time = UsTimer::Instance().read_us();
...
AccelStepper::AccelStepper(uint8_t interface, DigitalOut &&pin1,
                           DigitalOut &&pin2, DigitalOut &&pin3,
                           DigitalOut &&pin4, bool enable)
    : _pin0(std::move(pin1)), _pin1(std::move(pin2)), _pin2(std::move(pin3)),
      _pin3(std::move(pin4)) {
...
void AccelStepper::setEnablePin(DigitalOut &enablePin) {
